...
public class CheckView extends View {
    ...
    private static final float STROKE_RADIUS = 11.2f; // dp
    ...
    private void init(Context context) {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkClick != null && mediaBean != null) {
                    checkClick.onCheckViewClicked(CheckView.this, mediaBean);
                }
            }
        });
    }
    ...
    public boolean isChecked() {
        if (mCountable) {
            return mCheckedNum != UNCHECKED && mCheckedNum > 0;
        } else {
            return mChecked;
        }
    }
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int color = ta.getColor(0, checkTint);
            ta.recycle();
    ...
    public void bindMedia(MediaBean item) {
        mediaBean = item;
    }

    OnCheckClickListener checkClick;

    public void setOnCheckClickListener(OnCheckClickListener checkClick) {
        this.checkClick = checkClick;
    }

    public interface OnCheckClickListener {
        void onCheckViewClicked(CheckView checkView, MediaBean item);
    }
